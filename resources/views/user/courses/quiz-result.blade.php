    ...
    <div class="min-h-[90vh] bg-[#FFF9EB] flex flex-col items-center justify-center py-10 px-4">
        ...
        <div class="w-full max-w-4xl text-center">
            ...
            <div class="flex justify-center items-center mt-6 gap-4">
                <img src="/image/BADGE.png" alt="Badge" class="w-48 h-48">
                <a href="/image/BADGE.png" download class="bg-blue-500 text-white flex items-center px-4 py-2 rounded-lg shadow hover:bg-blue-700">
                    Download Badge
                </a>
            </div>
